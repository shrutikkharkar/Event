...
<html lang="en">
  ...
  <body>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="card event-details-container">
                <h3 class="card-title event-details-heading">
                  Event name
                  <a href="registration.html" class="btn btn-primary register-for-event">Register</a>
                </h3>
                <div class="card-body event-details-body">

                  <p id="eventDetalis">'.$row['eventDetails'].'</p>
    ...
    <script>
      ...
      var select_Events = document.getElementById("eventDetalis");
